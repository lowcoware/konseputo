...
**Started:** {{DATE}}
**Last update:** {{DATE}}
**Run root:** {{RUN_ROOT}}    <!-- this run's namespaced artifact dir under .konseputo-goal/ (e.g. .konseputo-goal/add-dark-mode-Ab3Kx9); isolates concurrent runs in the same working tree -->
